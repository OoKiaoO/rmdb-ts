...
const apiSettings = {
  ...
  authenticate: async (requestToken: string, username: string, password: string) => {  // double-check types
    const bodyData = {
      username,
      password,
  ...
  rateMovie: async (sessionId: number, movieId: number, value: string) => {  // double-check types
